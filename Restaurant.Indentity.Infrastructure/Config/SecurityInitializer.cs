...
namespace Restaurant.Identity.Infrastructure.Config
{
    public class SecurityInitializer
    {
        ...
        public SecurityInitializer(ILogger<SecurityInitializer> logger, 
        ...
        private void InitializePermissions(string permissionJsonFilePath)
        {
            ...
            try
            {
                ReadPermissions(permissionsJson);
        ...
        private void ReadPermissions(string permissionsJson)
        {
            ...
            foreach (var permission in permissionsJsonObject)
            {
                ...
                ApplicationPermission.Permissions.Add(objPermission.Mnemonic, objPermission);
            }
        }
    }
}
